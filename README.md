...
This project bundles Rust crates that ship under their own permissive
licenses (Apache-2.0 / MIT / ISC / BSD / Unicode / Zlib / OFL / Ubuntu Font
License / MPL-2.0). The full disclosure with license text is generated by
`cargo about` and committed to the repository:

- [`THIRD_PARTY_LICENSES.md`](THIRD_PARTY_LICENSES.md) — Markdown source
- [`THIRD_PARTY_LICENSES.html`](THIRD_PARTY_LICENSES.html) — browsable HTML (also bundled with the installer)
